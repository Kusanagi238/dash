    ...
    def dispatch(self, dash_app: Dash):
        def _dispatch():
            ...
            if asyncio.iscoroutine(response_data):
                # Instead of raising a generic Exception (which produces a 500 and
                # breaks async tests), return a 500 response with an explanatory message.
                cb_ctx.dash_response.set_data(
                ...
                cb_ctx.dash_response.status_code = 500
